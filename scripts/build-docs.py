...
for en in (False,True):
 ...
 for x in items:
  ...
  scope=('Applies to desktop 0.20.0 and the 0.20.x service. Labels and capabilities vary by channel; the installer version is authoritative. Development features are not implied.' if en else '适用于桌面 0.20.0 与 0.20.x 服务的基本流程。按钮与能力因渠道不同，以所装版本为准；不代表开发中功能已经随安装包发布。')
