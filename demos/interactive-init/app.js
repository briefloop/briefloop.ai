/* ==========================================================================
   BriefLoop Interactive Init — v0.15.3 READ-ONLY PREVIEW
...
(function () {
    ...
    var MESSAGES = {
        zh: {
            panel_title: "创建报告工作区",
            proto_banner: "v0.15.3 · 只读界面预览 · 不创建工作区",
            step_1: "报告方向",
            step_2: "交付与版式",
            step_3: "预览与确认",
            btn_back: "← 上一步",
        ...
        en: {
            ...
            proto_banner: "v0.15.3 · read-only interface preview · creates no workspace",
            step_1: "Direction",
