/* BriefLoop v0.15.3 three-page HTML preview.
...
(function () {
    ...
    var COPY = {
        zh: {
            proto_banner: "v0.15.3 · 三页只读预览 · 合成数据",
            quality: "质量状态",
            laj: "LAJ 建议",
            improvement: "改进状态",
        ...
        en: {
            proto_banner: "v0.15.3 · three-page read-only preview · synthetic data",
    ...
    function renderIdentity(main) {
        ...
        strip.appendChild(el("span", "status-pill-mini level-warning", "v0.15.3"));
